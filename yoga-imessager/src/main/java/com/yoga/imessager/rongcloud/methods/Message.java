package com.yoga.imessager.rongcloud.methods;

import com.yoga.imessager.rongcloud.messages.BaseMessage;
import com.yoga.imessager.rongcloud.models.CodeSuccessResult;
import com.yoga.imessager.rongcloud.models.HistoryMessageResult;
import com.yoga.imessager.rongcloud.models.TemplateMessage;
import com.yoga.imessager.rongcloud.util.GsonUtil;
import com.yoga.imessager.rongcloud.util.HostType;
import com.yoga.imessager.rongcloud.util.HttpUtil;
...
public class Message {
	...
	public CodeSuccessResult publishPrivate(String fromUserId, String[] toUserId, BaseMessage message, String pushContent) throws Exception {
		if (fromUserId == null) {
			throw new IllegalArgumentException("Paramer 'fromUserId' is required");
		}
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret, "/message/private/publish.json", "application/x-www-dto-urlencoded");
		HttpUtil.setBodyParameter(body, conn);
