...
<@html>
    ...
    <style>
        ...
        .loginWrapper {
            ...
            height: 300px;
            display: table;
            box-shadow: 3px 3px 30px #aaaaff;
        }
...
<div class="mainContainer">
    <div class="picContainer">
        <img onerror="this.src='/admin/login/back.jpg'" src="${img.loginBg!img.defaultBack}" alt="请添加LoginImg.bg">
    </div>
    <div class="loginContainer">
        <div style="padding-bottom: 20px">
            <img onerror="this.src='/admin/login/top.png'" src="${img.topImage!img.defaultTop}" alt="请添加LoginImg.top配置项">
        </div>
        <div class="loginWrapper">
            <div class="loginform">
                <img onerror="this.src='/admin/login/pick.png'" src="${img.pickLogin!img.defaultPick}" style="width: 300px;" alt="请添加LoginImg.pick配置项"/>
            </div>
            <div class="loginform">
                <form id="loginform" action="/admin/login" method="post" class="form-horizontal" style="padding-top: 15px;float: right;margin-right: 30px">
                    <div class="login_input form-group">
                        <input class="form-control" type="text" placeholder="请输入您的帐号" autocomplete="off" name="username" id="username" value="${(param.username)!}">
                    </div>
                    <div class="login_input form-group">
                        <input class="form-control" type="password" placeholder="请输入密码" autocomplete="off" name="password" id="password" value="${(param.password)!}">
