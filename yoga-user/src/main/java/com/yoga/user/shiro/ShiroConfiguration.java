...
public class ShiroConfiguration {
    ...
    public DefaultWebSecurityManager getDefaultWebSecurityManager(ApplicationContext applicationContext, SessionManager sessionManager, SubjectFactory subjectFactory) {
