...
<div class="container-fluid">
    <div class="row">
        <ol class="breadcrumb">
            <li><a href="#"><i class="icon icon-user"></i> 配置管理</a></li>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="tableToolContainer" style="margin-bottom:15px">
                        <form action="/setting/list" class="form-inline">
                            ...
                            <@shiro.hasPermission name="gbl_settable.update">
                                <div class="form-group" style="float: right">
                                    <a class="btn btn-info btn-primary" onclick="doSave()">
                    ...
                    <table id="" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <input type="hidden" value="${setting.setting.value?if_exists}">
                ...
                <div class="box-footer" style="text-align:center">
                    <@html.paging page=page param="" action="/setting/list"/>
                </div>
            </div>
        </div>
    </div>
