                        ...
                        <div class="videoBox">
                            <#list medias?if_exists as media>
                                <div class="audioItems">
                                    <div class="picCenter">
                                        <div class="audio" id="player_${media.id?if_exists?c}">
                                            <audio src="${media.url?if_exists}"></audio>
                                            <div class="audioDefault" style="background-size: 22px 18px" onclick="playAudio(this, ${media.id?if_exists?c})"></div>
                                            <div class="audioPlaying" style="background-size: 50px" onclick="playAudio(this, ${media.id?if_exists?c})"></div>
                                        </div>
                                        <div class="audioDetail">
                                            <label class="checkbox-inline">
                                                <input type="checkbox" name="material_id_checkbox" style="margin-top: 5px" value="${media.mediaId?if_exists}">${media.name?if_exists}
                                            </label><br>
                                            <span class="audioTime">创建于:${media.updateTime?datetime?if_exists}</span>
                                        </div>
                                    </div>
