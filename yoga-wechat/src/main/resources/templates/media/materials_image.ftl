                ...
                <div class="panel-body">
                    ...
                    <div class="imgSelect">
                        <div class="picHeader">
                            ...
                            <button class="picBtn" onclick="doBatchDelete()">删除</button>
                        </div>
                        <div class="picBox">
                            <#list medias?if_exists as media>
                                <div class="picItems">
                                    <div class="picCenter">
                                        <div class="picImg" onclick="doPreview(this, '${media.url?if_exists}')">
                                            <img src="${media.url?if_exists}">
                                        </div>
                                        <div class="picName">
                                            <input type="checkbox" class="picCheckBox" name="material_id_checkbox" value="${media.mediaId?if_exists}"/>
                                    ...
                                    <div class="picControl">
                                        ...
                                        <span onclick="setGroup(this, '${media.mediaId?if_exists}')"><i class="fa exchange"></i></span>
                                        <span onclick="doDelete(${media.id?if_exists?c})"><i class="fa trash"></i></span>
                                    </div>
                                </div>
                            </#list>
                        </div>
                        <div class="picGrowp">
                            <div class="padder">
                                <ul class="growpName">
                                    <button class="btn btn-block " id="group_id_" type="button" onclick="showGroup('');">
                                        全部
                                    </button>
                                    <button class="btn btn-block " id="group_id_0" type="button" onclick="showGroup('0');">
                                        未分组
                                    </button>
                                    <#list groups?if_exists as group>
                                        <button class="btn btn-block " id="group_id_${group.id?if_exists?c}" type="button" onclick="showGroup('${group.id?if_exists?c}');">${group.name?if_exists}
