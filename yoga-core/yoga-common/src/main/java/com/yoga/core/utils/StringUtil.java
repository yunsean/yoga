...
/**
 * @author qu.raoq
 * @version $Id: StringUtil.java, v 0.1 2016年9月20日 下午10:06:10 qu.raoq Exp $
 */
public class StringUtil {
    ...
    public static String format(final String format, final Object... args) {
        ...
        try {
            ...
            throw new RuntimeException("字符串格式失败", e);
        }
    }
     ...
     * @param str
     */
    public static Map<String, String> toMap(String key, String str) {
    ...
    public static String array2String(Object[] items) {
        if (items == null) return null;
        StringBuilder sb = new StringBuilder();
    ...
    /**
     * 将特殊字符转成 HTML 格式。等价于PHP中htmlspecialchars
     */
