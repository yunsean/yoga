...
public class CryptUtil {
	private static String ALGORITHM = "CryptUtil/CBC/PKCS5Padding";
	private static String ALGORITHM_128 = "CryptUtil/ECB/PKCS5Padding";//NoPadding
	private static String ENCODING = "utf-8";
	private static String MESSAGE_DIGEST = "SHA-256";
	private static String MESSAGE_DIGEST_128 = "MD5";
	private static String SECRET_KEY_SPEC = "CryptUtil";
