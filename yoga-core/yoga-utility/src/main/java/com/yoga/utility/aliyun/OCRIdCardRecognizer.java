...
@Service
@Settable(module = OCRIdCardRecognizer.ModuleName, key = OCRIdCardRecognizer.IDCardRecognizeAppId, name = "系统设置-身份证识别App Code", type = String.class)
public class OCRIdCardRecognizer {
    ...
    public OCRIdCardResult recognize(long tenantId, String url) {
        ...
        if (StringUtil.isBlank(appcode)) throw new BusinessException("尚未配置身份证识别APPCode！");
