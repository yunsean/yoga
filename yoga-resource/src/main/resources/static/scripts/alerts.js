var alertShow=function(type,infoContest,closeTime){
	...
	if(!testInfo.test(type)){
		...
		var AlertContent=
			'<div id="alertShow" class="alert alert-'+type+' alert-dismissable" style="width:500px">'+
				...
				'<h5>提示</h5>'+
		   		'<p style="text-align:center">'+infoContest+'</p>'+
			'</div>';
...
var warningModal=function(warningInfo,handleMethod,titleInfo){
              ...
              '<div class="modal-dialog">'+
                '<div class="modal-content">'+
                  ...
                  '<div class="modal-body">'+
                    '<p style="text-align:center">'+warningInfo+'</p>'+
                  '</div>'+
	...
	$("#warningBox").on("hidden.bs.modal",function(){
