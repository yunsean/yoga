package com.yoga.pay.wxpay.sdk;

import com.yoga.pay.wxpay.sdk.WXPayConstants.SignType;
...
//        }
    ...
    public Map<String, String> fillRequestData(Map<String, String> reqData) throws Exception {
        ...
        reqData.put("sign", WXPayUtil.generateSignature(reqData, config.getApiKey(), this.signType));
        return reqData;
    }
